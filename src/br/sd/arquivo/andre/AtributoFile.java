 ...
 * @author rafael
 */
public class AtributoFile implements Serializable{
    private int tamanho;
    ...
    public AtributoFile(int tamanho, long horaCriacao, long horaModificacao, long horaLeitura, long horaAtributo) {
